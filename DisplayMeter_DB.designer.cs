...
namespace DisplayMeter
{
    ...
    partial void Deletetran_LogMeter(tran_LogMeter instance);
		...
		[global::System.Data.Linq.Mapping.FunctionAttribute(Name="dbo.stp_get_LastMeter_ByUniq")]
		public ISingleResult<stp_get_LastMeter_ByUniqResult> stp_get_LastMeter_ByUniq([global::System.Data.Linq.Mapping.ParameterAttribute(Name="LackUniq", DbType="UniqueIdentifier")] System.Nullable<System.Guid> lackUniq)
		{
			IExecuteResult result = this.ExecuteMethodCall(this, ((MethodInfo)(MethodInfo.GetCurrentMethod())), lackUniq);
			return ((ISingleResult<stp_get_LastMeter_ByUniqResult>)(result.ReturnValue));
		}
	}
    ...
    partial void OnLogDateChanged();
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="sec_User_tran_LogMeter", Storage="_tran_LogMeters", ThisKey="UserName", OtherKey="UserName")]
		public EntitySet<tran_LogMeter> tran_LogMeters
		{
			get
			{
		...
		{
			this.SendPropertyChanging();
			entity.sec_User = this;
		}
		
		private void detach_tran_LogMeters(tran_LogMeter entity)
		{
			this.SendPropertyChanging();
			entity.sec_User = null;
		}
	}
	...
	public partial class tran_LogMeter : INotifyPropertyChanging, INotifyPropertyChanged
	{
		...
		private decimal _LogMeter1;
		
		private decimal _LogMeter2;
		
		private decimal _LogMeter3;
		
		private decimal _LogMeter4;
		...
		private EntityRef<sec_User> _sec_User;
    ...
    partial void OnLackUniqChanging(System.Guid value);
    partial void OnLackUniqChanged();
    partial void OnLogMeter1Changing(decimal value);
    partial void OnLogMeter1Changed();
    partial void OnLogMeter2Changing(decimal value);
    partial void OnLogMeter2Changed();
    partial void OnLogMeter3Changing(decimal value);
    partial void OnLogMeter3Changed();
    partial void OnLogMeter4Changing(decimal value);
    partial void OnLogMeter4Changed();
    partial void OnLogDateChanging(System.DateTime value);
    partial void OnLogDateChanged();
    partial void OnUserNameChanging(string value);
    partial void OnUserNameChanged();
		...
		public tran_LogMeter()
		{
			...
			this._sec_User = default(EntityRef<sec_User>);
			OnCreated();
		}
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_LogMeter1", DbType="Decimal(18,5) NOT NULL")]
		public decimal LogMeter1
		{
			get
			{
				return this._LogMeter1;
			}
			set
			{
				if ((this._LogMeter1 != value))
				{
					this.OnLogMeter1Changing(value);
					this.SendPropertyChanging();
					this._LogMeter1 = value;
					this.SendPropertyChanged("LogMeter1");
					this.OnLogMeter1Changed();
				}
			}
		}
		
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_LogMeter2", DbType="Decimal(18,5) NOT NULL")]
		public decimal LogMeter2
		{
			get
			{
				return this._LogMeter2;
			}
			set
			{
				if ((this._LogMeter2 != value))
				{
					this.OnLogMeter2Changing(value);
					this.SendPropertyChanging();
					this._LogMeter2 = value;
					this.SendPropertyChanged("LogMeter2");
					this.OnLogMeter2Changed();
				}
			}
		}
		
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_LogMeter3", DbType="Decimal(18,5) NOT NULL")]
		public decimal LogMeter3
		{
			get
			{
				return this._LogMeter3;
			}
			set
			{
				if ((this._LogMeter3 != value))
				{
					this.OnLogMeter3Changing(value);
					this.SendPropertyChanging();
					this._LogMeter3 = value;
					this.SendPropertyChanged("LogMeter3");
					this.OnLogMeter3Changed();
				}
			}
		}
		
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_LogMeter4", DbType="Decimal(18,5) NOT NULL")]
		public decimal LogMeter4
		{
			get
			{
				return this._LogMeter4;
			}
			set
			{
				if ((this._LogMeter4 != value))
				{
					this.OnLogMeter4Changing(value);
					this.SendPropertyChanging();
					this._LogMeter4 = value;
					this.SendPropertyChanged("LogMeter4");
					this.OnLogMeter4Changed();
				}
			}
		}
		...
		public string UserName
		{
			...
			set
			{
				if ((this._UserName != value))
				{
					if (this._sec_User.HasLoadedOrAssignedValue)
					{
						throw new System.Data.Linq.ForeignKeyReferenceAlreadyHasValueException();
					}
					this.OnUserNameChanging(value);
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="sec_User_tran_LogMeter", Storage="_sec_User", ThisKey="UserName", OtherKey="UserName", IsForeignKey=true)]
		public sec_User sec_User
		{
			get
			{
				return this._sec_User.Entity;
			}
			set
			{
				sec_User previousValue = this._sec_User.Entity;
				if (((previousValue != value) 
							|| (this._sec_User.HasLoadedOrAssignedValue == false)))
				{
					this.SendPropertyChanging();
					if ((previousValue != null))
					{
						this._sec_User.Entity = null;
						previousValue.tran_LogMeters.Remove(this);
					}
					this._sec_User.Entity = value;
					if ((value != null))
					{
						value.tran_LogMeters.Add(this);
					...
					this.SendPropertyChanged("sec_User");
				}
			}
		}
	...
	public partial class stp_get_LastMeter_ByUniqResult
	{
		...
		private System.Nullable<double> _LackSorting;
		...
		public stp_get_LastMeter_ByUniqResult()
		{
		}
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_LackDescription", DbType="NVarChar(50)")]
		public string LackDescription
		{
			get
			{
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_LackIPAddress", DbType="NVarChar(20)")]
		public string LackIPAddress
		{
			get
			{
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_LackSorting", DbType="Float")]
		public System.Nullable<double> LackSorting
		{
			get
			{
				return this._LackSorting;
